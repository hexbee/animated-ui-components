...
export function SignUpCard() {
  ...
  return (
    <div className="min-h-screen w-screen bg-black relative overflow-hidden flex items-center justify-center">
      {/* Background gradient effect - using blue/teal theme for signup */}
      <div className="absolute inset-0 bg-gradient-to-b from-blue-500/40 via-teal-700/50 to-black" />
      ...
      >
        ...
        >
          <div className="relative group">
            ...
            {/* Traveling light beam effects - same as sign-in but with blue tint */}
                    ...
                    >
                      ...
                      <div className="relative flex items-center overflow-hidden rounded-lg">
                        <Input
                          ...
                          onBlur={() => setFocusedInput(null)}
                          className="w-full bg-white/5 border-transparent focus:border-white/20 text-white placeholder:text-white/30 h-10 transition-all duration-300 pl-3 pr-3 focus:bg-white/10"
                        />
                        
                        {focusedInput === "lastName" && (
                          <motion.div 
                            layoutId="input-highlight-2"
                            className="absolute inset-0 bg-white/5 -z-10"
                            initial={{ opacity: 0 }}
                            animate={{ opacity: 1 }}
                            exit={{ opacity: 0 }}
